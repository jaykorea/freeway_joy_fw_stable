...
namespace rtabmap_ros
{
  ...
  class OdomInfo : public ros::Msg
  {
    ...
    OdomInfo():
      ...
      gravityRollError(0),
      gravityPitchError(0),
      localBundleIds_length(0), localBundleIds(NULL),
      localBundleModels_length(0), localBundleModels(NULL),
      localBundleModelTransforms_length(0), localBundleModelTransforms(NULL),
      localBundlePoses_length(0), localBundlePoses(NULL),
      transform(),
      transformFiltered(),
    ...
    const char * getMD5(){ return "1fa598d3d5fa4fd64473fc2a4cfbe1b3"; };
