#ifndef _ROS_mesh_msgs_MeshTriangleIndices_h
#define _ROS_mesh_msgs_MeshTriangleIndices_h
...
namespace mesh_msgs
{
  ...
  class MeshTriangleIndices : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "mesh_msgs/MeshTriangleIndices"; };
