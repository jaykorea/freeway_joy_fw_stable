...
namespace mesh_msgs
{
  ...
  class MeshMaterials : public ros::Msg
  {
    ...
    MeshMaterials():
      ...
      materials_length(0), materials(NULL),
      cluster_materials_length(0), cluster_materials(NULL),
      vertex_tex_coords_length(0), vertex_tex_coords(NULL)
    {
    }
    ...
    const char * getType(){ return "mesh_msgs/MeshMaterials"; };
    const char * getMD5(){ return "e151c9a065aae90d545559129a79a70a"; };
